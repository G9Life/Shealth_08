# SHealth_08 — 02-03단계: 함수 추출 리팩토링

> **통합 최종본**: [02_SHealth_08_1차_리팩토링_보고서.md](./02_SHealth_08_1차_리팩토링_보고서.md)  
> **후속 문서**: [02-04단계 — 반복/중복 제거](./02-04단계%20—%20반복중복%20제거%20리팩토링.md)

| 항목 | 내용 |
|------|------|
| **프로젝트명** | SHealth BMI (C++) |
| **작성일** | 2026-05-20 |
| **단계** | Activities 2 — 함수 추출 |
| **선행 문서** | [01_SHealth_08_프로젝트_분석_보고서.md](./01_SHealth_08_프로젝트_분석_보고서.md) |
| **세부 문서** | [02-01](./02-01단계%20—%20네이밍%20개선%20리팩토링.md) · [02-02](./02-02단계%20—%20하드코드%20및%20전역변수%20제거%20리팩토링.md) |
| **목적** | God Method 분해, 파이프라인·집계·`main` 헬퍼 추출 |
...
### 5.4 `main` 헬퍼 (`SHealthBMI.cpp`)

| 함수 | 역할 |
|------|------|
| `resolveDataFilePath()` | `shealth.dat` / `../shealth.dat` 경로 탐색 |
